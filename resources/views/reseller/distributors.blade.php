                            ...
                            <table class="table table-striped table-valign-middle datatable" id="distributorsTable">
                                ...
                                @foreach($distributors as $distributor)
                                    <tr id="{{$distributor->id}}">
                                        <td>{{$distributor->company_name}}
                                            @if($distributor->created_at > today())
                                            <span class="badge bg-danger">NEW</span>
                                            @endif
                                        </td>
                                        <td>{{$distributor->address['house_address']}},{{$distributor->address['street_address']}},{{$distributor->address['city']}}, {{$distributor->address['state']}}, {{$distributor->address['country']}}</td>
