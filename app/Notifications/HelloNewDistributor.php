...
class HelloNewDistributor extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                ...
                ->line('We would like to inform you that your account as a distributor has been created with the following details:')
